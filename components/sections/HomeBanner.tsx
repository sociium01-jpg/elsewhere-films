...
export function HomeBanner() {
  return (
    <section className="relative min-h-svh bg-ink-black">
      ...
      <div className="relative z-10 mx-auto grid min-h-svh max-w-frame content-end gap-10 px-5 pb-[max(4rem,env(safe-area-inset-bottom))] pt-[max(8rem,calc(env(safe-area-inset-top)+6rem))] md:px-10 md:pb-20 lg:grid-cols-12 lg:items-end lg:gap-x-10 lg:px-14">
        <div className="lg:col-span-7">
          ...
          <MaskReveal
            ...
            clip
            immediate
            className="mt-6 font-display text-[clamp(1.5rem,0.7rem+4.8vw,3.5rem)] font-bold uppercase leading-[1.22] tracking-[0.06em] text-ink-white md:tracking-[0.08em]"
            lines={[HOME.banner.headline[0], HOME.banner.headline[1]]}
            lineClassName={["sm:whitespace-nowrap", "sm:whitespace-nowrap md:ml-[8%] lg:ml-[12%]"]}
          />
        ...
        <div className="flex flex-col justify-end lg:col-span-5 lg:col-start-8 lg:pb-2">
          <FadeUp className="max-w-lede font-body text-[15px] font-light leading-body tracking-body text-ink-offWhite md:text-[16px] lg:ml-auto lg:text-right">
